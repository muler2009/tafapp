...
const MainTree = ({menu = []}: SideMenuInterface) => {
  ...
  return (
      <div className={`font-IBMPlexSans flex flex-col h-screen border-t border-r border-b border-gray-100 border-opacity-40 shadow-md z-10 cursor-pointer overflow-x-hidden text-white ${controller ? 'w-[22rem] bg-gray-50': 'w-[70px] bg-gray-50 text-white'}`}>
